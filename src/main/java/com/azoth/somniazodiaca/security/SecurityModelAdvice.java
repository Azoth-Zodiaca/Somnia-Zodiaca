 ...
 *
 * Spring passa qui l'oggetto Authentication della richiesta corrente: è il contenitore
 * che rappresenta l'utente loggato, i suoi ruoli e il suo stato di autenticazione.
...
public class SecurityModelAdvice {
     ...
     *
     * Questo metodo non concede permessi: prepara soltanto dati da leggere nelle view.
     */
    ...
    public CurrentUserView currentUser(Authentication authentication) {
        ...
        // Spring li conserva come GrantedAuthority, ad esempio ROLE_ADMIN e ROLE_OPERATORE.
